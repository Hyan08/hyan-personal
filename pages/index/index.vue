...
import mySignature from './components/mySignature.vue'
...
<template>
  <div class="relative">
    ...
    <div class="flex items-center">
      <span class="text-4">I am </span>
      <mySignature class="h-12" />
...
<style scoped>
.hello {
  animation: hello 2.5s linear infinite;
}
